-- 1. Create the database and all tables specified in the dataset (relational model) to meet
-- the specifications identified in task one. Clearly document all DDL statements used in
-- this process.                        
-- ▀███▀▀▀██▄ ▀███▀▀▀██▄ ▀████▀    
--   ██    ▀██▄ ██    ▀██▄ ██      
--   ██     ▀██ ██     ▀██ ██      
...
-- 2. Populate all database tables with the desired data. Clearly document all DML
-- statements used in this process.                            
-- ▀███▀▀▀██▄ ▀████▄     ▄███▀████▀    
--   ██    ▀██▄ ████    ████   ██      
--   ██     ▀██ █ ██   ▄█ ██   ██      
--   ██      ██ █  ██  █▀ ██   ██      
...
-- Inserting data into Type table
INSERT INTO Type (TypeName) VALUES 
  ('Electric'),
  ('Gas-powered'),
  ('Manual');

-- Inserting data into Manufacturer table
...
VALUES
    ('Lawnmower Service Agreement', 'Regular maintenance for lawnmower', 25.0, 12),
    ('Mowing by Staff for Summer', 'Staff-assisted lawn mowing during summer', 30.0, 3),
    ('Lawnmower Rental', 'Rent a lawnmower for personal use', 40.0, 1),
    ('Garden Design Consultation', 'Professional consultation for garden design', 22.5, 0),
    ('Seasonal Planting Service', 'Planting services for different seasons', 28.0, 3);
...
INSERT INTO Product (SupplierID, CategoryID, StatusID, Model, ManufacturerID, TypeID, Price) VALUES 
  (1, 1, 1, 'Lawnmower X1', 1, 1, 299.99),
  (2, 2, 1, 'Hedge Trimmer H2000', 2, 2, 129.99),
  (3, 3, 1, 'Garden Hose 50ft', 3, 3, 19.99);
...
VALUES
    (1, 1, '2023-01-01', '2023-04-01'),  
    (2, 2, '2023-02-15', NULL),          
    (3, 3, '2023-03-10', '2023-06-10');  

-- Insert data into Staff table
INSERT INTO Staff (RoleID, StoreID, AddressID, FirstName, LastName, ContactNumber, AnnualLeave, Pay, StartDate, EndDate) VALUES 
  (1, 1, 1, 'Michael', 'Johnson', '+353 87 765 4321', 25, 50000, '2010-01-01', NULL),
  (2, 2, 2, 'Emma', 'Wilson', '+353 86 543 2109', 20, 40000, '2023-02-15', NULL),
  (3, 3, 3, 'Liam', 'O''Brien', '+353 85 321 0987', 22, 45000, '2023-03-10', NULL),
  (5, 3, 3, 'Alan', 'Mad', '+353 85 321 0987', 22, 45000, '2023-03-15', '2023-06-15');
